...
compile_variants("qwen3.5_0.8b", "q4f16_1", 1024, "Qwen3.5-0.8B", repo_id="Qwen/Qwen3.5-0.8B")
compile_variants("qwen3.5_0.8b", "q4f32_1", 1024, "Qwen3.5-0.8B", repo_id="Qwen/Qwen3.5-0.8B")
compile_variants("qwen3.5_0.8b", "q0f16", 1024, "Qwen3.5-0.8B", repo_id="Qwen/Qwen3.5-0.8B")
compile_variants("qwen3.5_2b", "q4f16_1", 1024, "Qwen3.5-2B", repo_id="Qwen/Qwen3.5-2B")
compile_variants("qwen3.5_2b", "q4f32_1", 1024, "Qwen3.5-2B", repo_id="Qwen/Qwen3.5-2B")
compile_variants("qwen3.5_4b", "q4f16_1", 1024, "Qwen3.5-4B", repo_id="Qwen/Qwen3.5-4B")
compile_variants("qwen3.5_4b", "q4f32_1", 1024, "Qwen3.5-4B", repo_id="Qwen/Qwen3.5-4B")
compile_variants("qwen3.5_9b", "q4f16_1", 1024, "Qwen3.5-9B", repo_id="Qwen/Qwen3.5-9B")
compile_variants("qwen3.5_9b", "q4f32_1", 1024, "Qwen3.5-9B", repo_id="Qwen/Qwen3.5-9B")
compile_variants("phi_4_mini_instruct", "q4f16_1", 1024, "Phi-4-mini-instruct", repo_id="microsoft/Phi-4-mini-instruct")
compile_variants("phi_4_mini_instruct", "q4f32_1", 1024, "Phi-4-mini-instruct", repo_id="microsoft/Phi-4-mini-instruct")
compile_variants("olmo_2_0425_1b_instruct", "q4f16_1", 1024, "OLMo-2-0425-1B-Instruct", repo_id="allenai/OLMo-2-0425-1B-Instruct")
compile_variants("olmo_2_0425_1b_instruct", "q4f32_1", 1024, "OLMo-2-0425-1B-Instruct", repo_id="allenai/OLMo-2-0425-1B-Instruct")
compile_variants("olmo_2_1124_7b_instruct", "q4f16_1", 1024, "OLMo-2-1124-7B-Instruct", repo_id="allenai/OLMo-2-1124-7B-Instruct")
compile_variants("olmo_2_1124_7b_instruct", "q4f32_1", 1024, "OLMo-2-1124-7B-Instruct", repo_id="allenai/OLMo-2-1124-7B-Instruct")
